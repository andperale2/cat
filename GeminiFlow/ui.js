  ...
  bindEvents() {
    ...
    this.shadow.querySelector('#gf-load-direct-btn').addEventListener('click', () => {
      ...
      const directSteps = [
        ...
        { prompt: "Cinematic action shot: @foto1 (the attacker) vs @2 (the defender). @foto1 attacks relentlessly with rapid strikes surrounded by @EFFECT1; @2 remains completely still with arms crossed, projecting @EFFECT2 to parry the blows. Sharp impact particle burst on collision. Dynamic handheld camera angle, slight whip-in effect. Granular weight and thuds. COLOR GRADE: cinematic film, cool desaturated base, warm practical highlights.", delay: 4000 }
      ];
