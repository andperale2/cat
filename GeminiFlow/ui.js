...
class GeminiFlowUI {
  ...
  bindEvents() {
    ...
    this.shadow.querySelector('#gf-load-aas-btn').addEventListener('click', () => {
      ...
      const aasSteps = [
        { prompt: "Live-action cinematic photograph based on the composition of @1. Convert into photorealistic human skin texture, authentic fabric, natural hair strands, and physically accurate lighting. Enforce strict human biological proportions: exactly two arms, two legs, and five fingers per hand. Cinematic medium shot, 35mm film grain, anamorphic lens contrast, deep shadows. Avoid: anime drawing, 2D contours, plastic CGI skin, duplicate limbs, third arm, extra legs, fused fingers, body morphing, mutant anatomy.", delay: 4000 },
        { prompt: "Live-action cinematic photograph based on the composition of @2. Convert into photorealistic human skin texture, authentic fabric, natural hair strands, and physically accurate lighting. Enforce strict human biological proportions: exactly two arms, two legs, and five fingers per hand. Cinematic medium shot, 35mm film grain, anamorphic lens contrast, deep shadows. Avoid: anime drawing, 2D contours, plastic CGI skin, duplicate limbs, third arm, extra legs, fused fingers, body morphing, mutant anatomy.", delay: 4000 },
        { prompt: "10-SECOND CINEMATIC VIDEO SEQUENCE. OPENING (0-2s): High overhead shot, characters establish combat stance. CLASH (2-4s): @foto1 attacks relentlessly with rapid kinetic strikes; @foto2 remains perfectly still, executing micro-parries. IMPACT (4-7s): A sharp impact particle burst snaps on collision. Dynamic handheld camera orbiting the fighters with slight whip-in. FINISH (7-10s): @foto1 lands a decisive clean hit flush on target, whip-pan with micro slow-motion on impact. COLOR GRADE: cinematic film, cool desaturated base, warm practical highlights.", delay: 4000 }
      ];
    ...
    this.shadow.querySelector('#gf-load-direct-btn').addEventListener('click', () => {
      ...
      const directSteps = [
        ...
        { prompt: "10-SECOND CINEMATIC VIDEO SEQUENCE. OPENING (0-2s): High overhead shot, establishing combat stance. CLASH (2-4s): @foto1 attacks relentlessly with rapid kinetic strikes; opposing force parries. IMPACT (4-7s): A sharp impact particle burst snaps on collision. Dynamic handheld camera orbiting the fighter with slight whip-in. FINISH (7-10s): @foto1 lands a decisive clean hit flush on target, whip-pan with micro slow-motion on impact. COLOR GRADE: cinematic film, cool desaturated base, warm practical highlights.", delay: 4000 }
      ];
