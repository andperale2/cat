...
class GeminiFlowUI {
  ...
  bindEvents() {
    ...
    this.shadow.querySelector('#gf-load-aas-btn').addEventListener('click', () => {
      ...
      const aasSteps = [
        { prompt: "De-blur, sharpen, and denoise this anime frame into an ultra-crisp studio keyframe. Reconstruct and define clean contours, correct facial symmetry, natural hand structure with exactly 5 fingers per hand, and sharp fabric folds. Preserve the exact composition and color palette of the source. Avoid: blur, pixelation, compression artifacts, distorted anatomy, extra limbs, fused fingers, cartoon smear.", delay: 4000 },
        { prompt: "Live-action cinematic photograph based on the restored composition @foto1. Convert into photorealistic human skin texture, authentic fabric, natural hair strands, and physically accurate lighting. Enforce strict human biological proportions: exactly two arms, two legs, and five fingers per hand. Cinematic medium shot, 35mm film grain, anamorphic lens contrast, deep shadows. Avoid: anime drawing, 2D contours, plastic CGI skin, duplicate limbs, third arm, extra legs, fused fingers, body morphing, mutant anatomy.", delay: 4000 },
        { prompt: "SCENE @foto2 vs @2 | SHOT 1 5S I2V. REFS: @foto2 the attacker, @2 the defender, @3 the arena plate. @foto2 attacks relentlessly with rapid strikes; @2 remains completely still with arms crossed. At the exact instant of each blow, a sharp impact particle burst snaps up to parry then immediately vanishes. Dynamic handheld camera orbiting the fighters with slight whip-in on impact. Granular weight and thuds. COLOR GRADE: cinematic film, cool desaturated base, warm practical highlights, filmic contrast, subtle teal-orange, fine grain, anamorphic.", delay: 4000 },
        { prompt: "SCENE @foto2 vs @2 | STRIKE 1 (2-4s): @foto2 blurs in at high speed behind @2. RAPID FLURRY (4-12s): Relentless assault from alternating angles; sand parries later and harder each time. FINISH (12-15s): @foto2 lands a decisive clean hit flush on target, whip-pan with micro slow-motion on impact. COLOR GRADE: cinematic film, cool desaturated base, fine grain.", delay: 4000 }
      ];
